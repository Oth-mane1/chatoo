...
export function SignIn(props) {
	...
	return (
		<div className="md:w-4/6 mx-12 md:m-auto flex items-center justify-center flex-col">
			<h1 className="w-full text-left font-extrabold text-gray-800 text-4xl">Welcome Back!</h1>
			...
			<p className="w-full text-left my-4">Don't have an account? no problem <button className="text-blue-jelly font-semibold hover:underline" onClick={() => { showLoader(); setIsSignIn(false) }}>Sign Up</button> here.</p>
		</div>
	);
}
